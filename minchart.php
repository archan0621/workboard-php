...
$query = "SELECT * FROM sdata WHERE time BETWEEN DATE_SUB('".$sdate." ".$stime.":00', INTERVAL 30 MINUTE) AND DATE_ADD('".$sdate." ".$stime.":00', INTERVAL 30 MINUTE) order by METER_SEQ, TIME";
...
<form action="minchart.php" method="get">
...
<figure class="highcharts-figure">
    <div id="container1" style="height: 00px"></div>
    <div id="container2" style="height: 00px"></div>
    <div id="container3" style="height: 00px"></div>
    <div id="container4" style="height: 00px"></div>
    <div id="container5" style="height: 00px"></div>
    </figure>                                                                                                                                                                                                                  
<figure class="highcharts-figure">                                                                                                                                                                                                                   
    <div id="container6" style="height: 00px"></div>  
    <div id="container7" style="height: 00px"></div>  
    <div id="container8" style="height: 00px"></div>  
    <div id="container9" style="height: 00px"></div>  
    <div id="container10"style="height: 00px"></div>   
</figure>                                                                                                                                                                                                                  
<figure class="highcharts-figure">                                                                                                                                                                                                                   
